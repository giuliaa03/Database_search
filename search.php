    ...
    <body>
        ...
        <div> 
            ...
            <form method="POST" style="text-align: center" action="search.php">
                ...
                <input onclick="hide()" type="submit"><br><br>
...
<!-- INSERT INTO `evenimente` (`numeleEvenimentului`, `dataEveniment`, `descriereEveniment`) VALUES ('ziua lui Eminescu', '2020-01-15', 's-a sărbătorit'); -->
...
<?php
    ...
    if (isset($_POST['year']) && isset($_POST['month']) && isset($_POST['day'])) {
                ...
                $sql = ""; 
                #Am adăugat stringul acesta gol la început pentru a putea apela funția de la linia 245
